        ...
        <main>
            ...
            <div class="top">
                ...
                <div class="buy">
                    <div class="left">
                        <span>购买数量</span>
                        <span>(每人限购{{ goodsInfo.purchase_limit }}件)</span>
                    </div>
                    <div class="right">
                        <span
                            @click="subEvt()"
                            :class="[goods_num <= 1 && 'act']"
                            >-</span
                        >
                        <span>{{ goods_num }}</span>
                        <span @click="addEvt()">+</span>
                    </div>
                </div>
                <!--  -->
                <div class="youhui">
...
async function payCancelEvt() {
    let obj = {
        ...
        goods_price: settlement_price.value,
